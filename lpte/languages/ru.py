...
_RUSSIAN_WORD_CATEGORIES: dict[str, str] = {
    **{w: "slur" for w in (
        "пидор", "пидорас", "пидорасы", "педик", "гомик", "сука",
        "суки", "сучка", "сучара", "сучий", "шлюха", "шлюхи",
        "проститутка", "курва", "ублюдок", "ублюдки", "тварь", "твари",
        "мразь", "мрази",
    )},
    **{w: "sexual" for w in (
        "хуй", "хуя", "хуе", "хуем", "хую", "хуи",
        "хуев", "хуями", "хуях", "хуйня", "хуйни", "хуйне",
        "хуйню", "хуйней", "хуесос", "хуесосы", "хуеплет", "пизда",
        "пизды", "пизде", "пизду", "пиздой", "пиздец", "пиздежа",
        "пиздеть", "пиздюк", "пиздобол", "распиздяй", "ебать", "ебет",
        "ебут", "ебал", "ебала", "ебали", "ебаный", "ебаная",
        "ебанутый", "ебанутая", "заебал", "заебала", "заебись", "охуеть",
        "охуел", "охуела", "ахуеть",
    )},
    **{w: "insult" for w in (
        "мудак", "мудаки", "мудила", "гондон", "гандон", "гандоны",
        "дебил", "дебилы", "идиот", "идиотка", "кретин", "еблан",
        "ебло", "долбоеб", "долбоёб", "долбоебы", "говнюк", "козел",
        "козлина", "дерьмо", "говно",
    )},
}
...
RussianProfile = LanguageProfile(
    ...
    word_categories=_RUSSIAN_WORD_CATEGORIES,
    context_rules={
