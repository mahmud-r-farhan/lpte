...
class ArabicStemmer(Stemmer):
    ...
    Strips common prefixes (الـ, و, ف, ب, ك, ل, س) and suffixes (ـها, ـهم, ـهن, ـكم, ـكن, ـنا, ـي, ـك, ـه, ـة, ـات, ـين, ـون).
    """
...
_ARABIC_BAD_WORDS: set[str] = {
    # Insults & profanity
    "شرموطة", "شرموط", "قحبة", "منيوك", "منيوكة",
    "كس", "كسختك", "طيز", "زب", "عرص",
